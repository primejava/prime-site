package org.primejava.basic.query;
...
import org.primejava.basic.util.ConvertUtils;
import org.primejava.basic.util.StringUtils;
...
public class PropertyFilter {
    ...
    /** match type. */
    private MatchType matchType;//匹配类型，大于等于小于。。。

    /** match value. */
    private Object matchValue;

    /** property class. */
    private Class<?> propertyClass;//这个字段是整形，还是字符型还是Boolean...
