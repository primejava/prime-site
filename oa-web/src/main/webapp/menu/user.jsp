	...
	<div class="panel panel-default">
		<div class="panel-heading" role="tab" id="collapse-header-user"
			...
			<h4 class="panel-title">
				<i class="glyphicon glyphicon-list"></i> <span class="title">用户管理</span>
			</h4>
		</div>
		<div id="collapse-body-user"
			class="panel-collapse collapse ${currentMenu == 'user' ? 'in' : ''}"
			role="tabpanel" aria-labelledby="collapse-header-user">
			<div class="panel-body">
				<ul class="nav nav-list">
					<li><a href="${ctx}/admin/user/users"><i class="glyphicon glyphicon-list"></i> 用户列表</a></li>
					<li><a href="${ctx}/admin/user/input"><i class="glyphicon glyphicon-list"></i> 添加用户</a></li>
				</ul>
			</div>
		</div>
	</div>
