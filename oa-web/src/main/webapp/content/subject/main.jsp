...
.attention{width: 660px;height: 350px;border-right: 1px solid #e9e9e9;padding-right: 20px;}
.attention .title{height: 40px;width: 100%;background: url(../images/website/attention.png) no-repeat right bottom;line-height: 40px;font-size: 22px;color: #004c8f;position: relative;}
.attention .title .more{width: 550px;height: 22px;position: absolute;bottom: 0;right: 0;margin-right: 1px;}
.attention .title .more .more-left{height: 22px;width: 50%;line-height: 22px;color: #cbd0d4;font-size: 12px;}
.attention .title .more .more-right{height: 22px;width: 50%;line-height: 22px;text-align: right;}
.attention .title .more .more-right a{font-size: 12px;color: #929ba9;}
.attention .title .more .more-right a:hover{text-decoration: underline;}
.attention .content{width: 100%;height: 300px;}
.smallslider ul li img{width:499px;height: 393px;}
.smallslider div.smallslider-lay{opacity: 0 !important;}
.smallslider  h3.smallslider-tex{bottom: 20px !important;}
</style>
...
<div class="gas-station">
	...
	<div class="container">
		...
		<div class="fix-right-layout">
			<%-- 轮播图 --%>
				<div  id="silder" class="smallslider" style="width:499px;height: 393px;">
					<ul>
					<li><a href="image/001.jpg"><img src="${ctx}/upload/1445505770748_6441.png" width="499" height="393" alt="图片标题1" /></a></li>
		           <li><a href="image/002.jpg"><img src="${ctx}/upload/1445505770748_6441.png" width="499" height="393" alt="图片标题2" /></a></li>
		           <li><a href="image/003.jpg"><img src="${ctx}/upload/1445505770748_6441.png" width="499" height="393" alt="图片标题3" /></a></li>
		           <li><a href="image/004.jpg"><img src="${ctx}/upload/1445505770748_6441.png" width="499" height="393" alt="图片标题4" /></a></li>
		           <li><a href="image/005.jpg"><img src="${ctx}/upload/1445505770748_6441.png" width="499" height="393" alt="图片标题5" /></a></li>
					</ul>
			</div>
		</div>
		<div class="space"></div>
