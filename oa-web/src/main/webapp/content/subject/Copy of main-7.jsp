...
.three-module .title{height: 50px;line-height: 50px;border-bottom: 2px solid #004c8f;font-size: 18px;color: #000;}
...
.listUl.li{width: 100%;height: 30px;line-height: 30px;border-bottom: 1px dashed #c9ced3;margin-bottom: 2px;word-break:keep-all;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}
.listUl li a{font-size: 12px;font-weight:bold;color: #666;vertical-align: middle;}
.listUl li a:hover{text-decoration: underline;}

.one-attention{ width: 980px;height: 270px;border-right: 1px solid #e9e9e9;padding-right: 20px;}
.one-attention .title{height: 40px;width: 100%;background: url(../images/website/attention.png) no-repeat right bottom;line-height: 40px;font-size: 24px;color: #004c8f;position: relative;}
...
.one-attention .content{width: 100%;height: 240px;}
...
.one-attention-module .module-content{width:100%;height: 75%;font-size: 12px;line-height: 25px;overflow: hidden;}
...
.two-attention{width: 660px;height: 350px;border-right: 1px solid #e9e9e9;padding-right: 20px;}
.two-attention .title{height: 40px;width: 100%;background: url(../images/website/attention.png) no-repeat right bottom;line-height: 40px;font-size: 22px;color: #004c8f;position: relative;}
.two-attention .title .more{width: 550px;height: 22px;position: absolute;bottom: 0;right: 0;margin-right: 1px;}
.two-attention .title .more .more-left{height: 22px;width: 50%;line-height: 22px;color: #cbd0d4;font-size: 12px;}
.two-attention .title .more .more-right{height: 22px;width: 50%;line-height: 22px;text-align: right;}
.two-attention .title .more .more-right a{font-size: 12px;color: #929ba9;}
.two-attention .title .more .more-right a:hover{text-decoration: underline;}
.two-attention .content{width: 100%;height: 300px;}

.zero-viwepager{width: 450px;height: 335px;float: right;position: relative;overflow:hidden;margin-right: 230px;margin-top: -5px;}
.zero-viwepager ul {width : 422px; height: 100%;overflow : hidden;position : relative;}
.zero-viwepager ul li .selected{display: block;}
.zero-viwepager ul img{width: 422px;height: 340px;cursor: pointer;}
	...
	<div class="container">
		...
		<div class="fix-right-layout" style="background-color: #fff;">
			<div class="adaptive-left attention" >
				<div class="title" style="border-bottom: 2px solid #004c8f;">
					<div class="more">
						<div class="fix-right more-right">
							<a target="_blank"
					...
					<span style="color: #004c8f; font-size: 22px;">通知</span><span style="color: yellow; font-size: 22px;">公告</span>
				</div>
			...
			<div class="fix-right" style="height: 350px;width:300px; ">
				<div class="essence-title">
					<span style="color: #004c8f; font-size: 22px;">创业</span><span style="color: yellow; font-size: 22px;">视频</span> <label
						class="a"
				...
				<ul class="listUl" style="margin-top: 5px;">
					<li><a href="subjectNews-detail-402821ec536001af015360119cfb0009.html">关于参加2016年吹牛逼大赛的工作知道</a></li>
					<li><a href="subjectNews-detail-402821ec536001af015360119cfb0009.html">关于参加2016年吹牛逼大赛的工作知道</a></li>
				</ul>	
			</div>
		...
		<div class="three-module">
			<div class="title">
				<span style="color: #004c8f; font-size: 22px;">校友</span><span style="color: yellow; font-size: 22px;">信息</span> 
				 <label class="a"
		...
		<div class="three-module">
			<div class="title">
			<span style="color: #004c8f; font-size: 22px;">创新</span><span style="color: yellow; font-size: 22px;">创业</span> 
				 <label class="a"
					onclick="window.open('subject-list.106104.402821f0515cbab601515cbce93f0002.html')">更多&gt;&gt;</label>
			</div>
		...
		<div class="three-module" >
			<div class="title">
			<span style="color: #004c8f; font-size: 22px;">推荐</span><span style="color: yellow; font-size: 22px;">书籍</span> 
				 <label class="a"
					onclick="window.open('subject-list.106104.402821f0515cbab601515cbce93f0002.html')">更多&gt;&gt;</label>
			</div>
			<div class="first-content" style="margin-top: 20px;" >
...
<script>
		function bulidSlider() {
			var slider = $('.zero-viwepager').smallslider({
				time : 5000,
				switchTime : 1000,
				onImageStop : false,
				showButtons : true,
