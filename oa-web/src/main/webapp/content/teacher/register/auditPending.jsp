...
<%
	pageContext.setAttribute("currentHeader", "register");
%>
<%
	pageContext.setAttribute("currentMenu", "register");
%>
<!doctype html>
<html>
<head>
...
<script type="text/javascript">
	var config = {
		...
		function doAudit(status,registerId) {
			$('#modal form').attr('action', ROOT_URL + '/admin/registerAudit/auditHistory.do');
...
<body>
	...
	<div class="row-fluid">
		<%@include file="/menu/teacher/register.jsp"%>
		...
		<!-- 工具条开始 -->
			...
			<form id="registerGridForm" name="registerGridForm" method='post'
				action="deleteregisters.do" class="m-form-blank">
				<table id="registerGrid" class="table table-hover">
					<thead>
						<tr>
