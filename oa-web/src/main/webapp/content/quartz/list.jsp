...
<%
	pageContext.setAttribute("currentHeader", "quartz");
%>
<%
	pageContext.setAttribute("currentMenu", "quartz");
%>
<!doctype html>
<html>
<head>
...
<body>
	<%@include file="/header/quartz.jsp"%>
	<div class="row-fluid">
	<%@include file="/menu/quartz.jsp"%>
	...
	<form id="addForm" method="post">
			...
			<tbody>
				<c:forEach var="job" items="${taskList}">
					<tr>
						...
						<td><a href="javascript:;" onclick="updateCron('${job.id}')">编辑cron</a></td>
					</tr>
				</c:forEach>
				<tr>
					<td>n</td>
		...
		function changeJobStatus(id, cmd) {
			showWaitMsg();
			$.ajax({
				type : "POST",
				async : false,
