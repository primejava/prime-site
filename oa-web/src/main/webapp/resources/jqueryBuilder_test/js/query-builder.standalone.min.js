...
!function(a, b) {
    ...
    "use strict";
    $.extendext = function() {
        var a, b, c, d, e, f, g = arguments[0] || {}, h = 1, i = arguments.length, j = !1, k = "default";
        for ("boolean" == typeof g && (j = g, g = arguments[h++] || {}), "string" == typeof g && (k = $([g.toLowerCase(), "default"]).filter(["default", "concat", "replace", "extend"])[0], g = arguments[h++] || {}), "object" == typeof g || $.isFunction(g) || (g = {}), h === i && (g = this, h--); i > h; h++)
            if (null !== (a = arguments[h]))
                if ($.isArray(a) && "default" !== k)
                    switch (f = g && $.isArray(g) ? g : [], k) {
                        case "concat":
    ...
    "function" == typeof define && define.amd ? define("query-builder", ["jquery", "jQuery.extendext"], b) : b(a.jQuery)
}(this, function($) {
    "use strict";
    function a(b) {
    ...
    function b(a, b) {
        b.forEach(function(b) {
            Object.defineProperty(a.prototype, b, {enumerable: !0,get: function() {
                    return this.__[b]
                },set: function(a) {
    ...
    $.extend(j.prototype, {change: function(a, b) {
            var c = new $.Event(a + ".queryBuilder.filter", {builder: this,value: b});
            return this.$el.triggerHandler(c, k.call(arguments, 2)), c.value
        },trigger: function(a) {
            var b = new $.Event(a + ".queryBuilder", {builder: this});
        ...
        this.$el.on("change.queryBuilder", ".rules-group-header [name$=_cond]", function() {
            ...
            var c = $(this).closest(".rules-group-container");
            b.deleteGroup(a(c))
        })), this.model.on({drop: function(a, b) {
                b.$el.remove()
            },add: function(a, b, c) {
        ...
        a = void 0 === a || a === !0;
        var c = this.nextGroupId(), d = $(this.template.group.call(this, c, 1));
        ...
        b = void 0 === b || b === !0;
        var d = a.level + 1, e = this.trigger("beforeAddGroup", a, b, d);
        if (e.isDefaultPrevented())
            return null;
        var f = this.nextGroupId(), g = $(this.template.group.call(this, f, d)), h = a.addGroup(g);
        ...
        var b = this.change("getRuleFilters", this.filters, a), c = $(this.getRuleFilterSelect(a, b));
        ...
        if (a.filter) {
            var c = this.getOperators(a.filter), d = $(this.getRuleOperatorSelect(a, c));
        ...
        this.clearErrors();
        var a = this, b = function c(b) {
            var d = 0, e = 0;
            return b.each(function(b) {
                if (!b.filter)
                    return a.triggerValidationError(b, "no_filter", null), void e++;
                if (0 !== b.operator.nb_inputs) {
                    var c = a.validateValue(b, b.value);
                    if (c !== !0)
                        return a.triggerValidationError(b, c, b.value), void e++
                }
                d++
            }, function(a) {
                c(a) ? d++ : e++
        ...
        if (!this.validate())
            return {};
        var a = function b(a) {
            var c = {condition: a.condition,rules: []};
            return a.data && (c.data = $.extendext(!0, "replace", {}, a.data)), a.each(function(a) {
                var b = null;
                0 !== a.operator.nb_inputs && (b = a.value);
                var d = {id: a.filter.id,field: a.filter.field,type: a.filter.type,input: a.filter.input,operator: a.operator.type,value: b};
        ...
        !function c(a, d) {
            null !== d && (void 0 === a.condition ? a.condition = b.settings.default_condition : -1 == b.settings.conditions.indexOf(a.condition) && e('Invalid condition "{0}"', a.condition), d.condition = a.condition, a.rules.forEach(function(a) {
                ...
                if (a.rules && a.rules.length > 0)
                    -1 != b.settings.allow_groups && b.settings.allow_groups < d.level ? (b.reset(), e("No more than {0} groups are allowed", b.settings.allow_groups)) : (f = b.addGroup(d, !1, a.data), c(a, f));
                else {
                    if (void 0 === a.id && e("Missing rule field id"), void 0 === a.operator && (a.operator = "equal"), f = b.addRule(d, a.data), null === f)
                        return;
        ...
        var c, d = a.filter, f = a.operator, g = d.validation || {}, h = !0;
        ...
        for (var b = [], c = 0, d = this.operators.length; d > c; c++) {
            if (a.operators) {
                if (-1 == a.operators.indexOf(this.operators[c].type))
                    continue
            } else if (-1 == this.operators[c].apply_to.indexOf(j.types[a.type]))
                continue;
        ...
        var b = a.filter, c = a.operator, d = [];
        if (b.valueGetter)
            d = b.valueGetter.call(this, a);
        else {
        ...
        var c = a.filter, d = a.operator;
        if (c.valueSetter)
            c.valueSetter.call(this, a, b);
        else {
        ...
        return a.readonly && $.extend(b, {filter_readonly: !0,operator_readonly: !0,value_readonly: !0,no_delete: !0}), a.flags && $.extend(b, a.flags), this.change("parseRuleFlags", b, a)
        ...
        for (var c = "", d = 0, e = this.settings.conditions.length; e > d; d++) {
            var f = this.settings.conditions[d], g = this.lang.conditions[f] || f;
        ...
        var b = '<li id="' + a + '" class="rule-container">   <div class="rule-header">   <div class="btn-group pull-right rule-actions">     <button type="button" class="btn btn-xs btn-danger" data-delete="rule">       <i class="' + this.icons.remove_rule + '"></i> ' + this.lang.delete_rule + "     </button>   </div>   </div>   " + (this.settings.display_errors ? '<div class="error-container"><i class="' + this.icons.error + '"></i></div>' : "") + '  <div class="rule-filter-container"></div>   <div class="rule-operator-container"></div>   <div class="rule-value-container"></div> </li>';
        return this.change("getRuleTemplate", b)
    }, j.prototype.getRuleFilterSelect = function(a, b) {
        var c = null, d = '<select class="form-control" name="' + a.id + '_filter">';
        return d += '<option value="-1">' + this.settings.select_placeholder + "</option>", b.forEach(function(a) {
            c != a.optgroup && (null !== c && (d += "</optgroup>"), c = a.optgroup, null !== c && (d += '<optgroup label="' + c + '">')), d += '<option value="' + a.id + '">' + a.label + "</option>"
        }), null !== c && (d += "</optgroup>"), d += "</select>", this.change("getRuleFilterSelect", d, a)
    }, j.prototype.getRuleOperatorSelect = function(a, b) {
        for (var c = '<select class="form-control" name="' + a.id + '_operator">', d = 0, e = b.length; e > d; d++) {
        ...
        var d = a.filter, e = a.filter.validation || {}, f = a.id + "_value_" + b, g = d.vertical ? " class=block" : "", h = "";
        if ("function" == typeof d.input)
            h = d.input.call(this, a, f);
        else
            switch (d.input) {
                case "radio":
                ...
                case "checkbox":
                    ...
                    break;
                case "select":
                    h += '<select class="form-control" name="' + f + '"' + (d.multiple ? " multiple" : "") + ">", c(d.values, function(a, b) {
                ...
                default:
                    switch (j.types[d.type]) {
                        case "number":
                            h += '<input class="form-control" type="number" name="' + f + '"', void 0 !== e.step && (h += ' step="' + e.step + '"'), void 0 !== e.min && (h += ' min="' + e.min + '"'), void 0 !== e.max && (h += ' max="' + e.max + '"'), d.placeholder && (h += ' placeholder="' + d.placeholder + '"'), d.size && (h += ' size="' + d.size + '"'), h += ">";
                            break;
                        default:
                            h += '<input class="form-control" type="text" name="' + f + '"', d.placeholder && (h += ' placeholder="' + d.placeholder + '"'), "string" === d.type && void 0 !== e.min && (h += ' minlength="' + e.min + '"'), "string" === d.type && void 0 !== e.max && (h += ' maxlength="' + e.max + '"'), d.size && (h += ' size="' + d.size + '"'), h += ">"
                    }
            }
        return this.change("getRuleInput", h, a, f)
    }, $.extend(a.prototype, {trigger: function(a) {
    ...
    var l = function(a, b) {
        return this instanceof l ? (Object.defineProperty(this, "__", {value: {}}), b.data("queryBuilderModel", this), this.__.level = 0, this.__.error = null, this.__.data = void 0, this.$el = b, this.id = b[0].id, this.model = null, void (this.parent = a)) : new l
    };
    b(l, ["level", "error", "data"]), Object.defineProperty(l.prototype, "parent", {enumerable: !0,get: function() {
    ...
    n.prototype = Object.create(l.prototype), n.prototype.constructor = n, b(n, ["filter", "operator", "flags", "value"]), j.Group = m, j.Rule = n, $.fn.queryBuilder = function(a) {
        ...
        var b = this.data("queryBuilder"), c = "object" == typeof a && a || {};
        ...
        this.on("getRuleInput.filter", function(b, d, e) {
            ...
            if (("radio" === f.input || "checkbox" === f.input) && !f.plugin) {
                ...
                var g, h, i = f.vertical ? ' style="display:block"' : "", j = 0;
    ...
    }, {font: "glyphicons",color: "default"}), j.define("bt-selectpicker", function(a) {
    ...
    }, {container: "body",style: "btn-inverse btn-xs",width: "auto",showIcon: !1}), j.define("bt-tooltip-errors", function(a) {
    ...
    }, {placement: "right"}), j.define("filter-description", function(a) {
        "inline" === a.mode ? this.on("afterUpdateRuleFilter", function(b, c) {
        ...
        }) : "popover" === a.mode ? ($.fn.popover && $.fn.popover.Constructor && $.fn.popover.Constructor.prototype.fixTitle || e('Bootstrap Popover is required to use "filter-description" plugin. Get it here: http://getbootstrap.com'), this.on("afterUpdateRuleFilter", function(b, c) {
            var d = c.$el.find("button.filter-description");
            c.filter && c.filter.description ? (0 === d.length ? (d = $('<button type="button" class="btn btn-xs btn-info filter-description" data-toggle="popover"><i class="' + a.icon + '"></i></button>'), d.prependTo(c.$el.find(".rule-actions")), d.popover({placement: "left",container: "body",html: !0}), d.on("mouseout", function() {
                d.popover("hide")
            ...
            c.filter && c.filter.description ? (0 === d.length && (d = $('<button type="button" class="btn btn-xs btn-info filter-description" data-toggle="bootbox"><i class="' + a.icon + '"></i></button>'), d.prependTo(c.$el.find(".rule-actions")), d.on("click", function() {
    ...
    }, {icon: "glyphicon glyphicon-info-sign",mode: "popover"}), j.defaults({mongoOperators: {equal: function(a) {
                return a[0]
                ...
                return {$ne: null}
            }},mongoRuleOperators: {$ne: function(a) {
                return a = a.$ne, {val: a,op: null === a ? "is_not_null" : "" === a ? "is_not_empty" : "not_equal"}
            },eq: function(a) {
                return {val: a,op: null === a ? "is_null" : "" === a ? "is_empty" : "equal"}
            },$regex: function(a) {
                return a = a.$regex, "^(?!" == a.slice(0, 4) && ")" == a.slice(-1) ? {val: a.slice(4, -1),op: "not_begins_with"} : "^((?!" == a.slice(0, 5) && ").)*$" == a.slice(-5) ? {val: a.slice(5, -5),op: "not_contains"} : "(?<!" == a.slice(0, 4) && ")$" == a.slice(-2) ? {val: a.slice(4, -2),op: "not_ends_with"} : "$" == a.slice(-1) ? {val: a.slice(0, -1),op: "ends_with"} : "^" == a.slice(0, 1) ? {val: a.slice(1),op: "begins_with"} : {val: a,op: "contains"}
            },between: function(a) {
                return {val: [a.$gte, a.$lte],op: "between"}
            },$in: function(a) {
                return {val: a.$in,op: "in"}
            },$nin: function(a) {
                return {val: a.$nin,op: "not_in"}
            },$lt: function(a) {
                return {val: a.$lt,op: "less"}
            },$lte: function(a) {
                return {val: a.$lte,op: "less_or_equal"}
            },$gt: function(a) {
                return {val: a.$gt,op: "greater"}
            },$gte: function(a) {
                return {val: a.$gte,op: "greater_or_equal"}
            }}}), j.extend({getMongo: function(a) {
            a = void 0 === a ? this.getRules() : a;
            var b = this;
            return function c(a) {
                if (a.condition || (a.condition = b.settings.default_condition), -1 === ["AND", "OR"].indexOf(a.condition.toUpperCase()) && e('Unable to build MongoDB query with condition "{0}"', a.condition), !a.rules)
                    return {};
                var d = [];
                a.rules.forEach(function(a) {
                    if (a.rules && a.rules.length > 0)
                        ...
                        var g = b.settings.mongoOperators[a.operator], h = b.getOperatorByType(a.operator), i = [];
            ...
            return function d(a) {
                ...
                var g = f[0].toLowerCase() === c[0] ? "AND" : "OR", h = a[f[0]], i = [];
                h.forEach(function(a) {
                    var f = Object.keys(a);
                    if (-1 !== c.indexOf(f[0].toLowerCase()))
                        i.push(d(a));
                    else {
                        var g = f[0], h = a[g], j = b.determineMongoOperator(h, g);
                        ...
                        var l = k.call(b, h);
                        i.push({id: b.change("getMongoDBFieldID", g, h),field: g,operator: l.op,value: l.val})
                    }
                });
                var j = {};
        ...
        this.on("afterInit", function(b) {
            ...
            var c = $(a.value);
            c.find(".rule-header").after('<div class="drag-handle"><i class="' + b.icon + '"></i></div>'), a.value = c.prop("outerHTML")
        })
    }, {default_no_sortable: !1,icon: "glyphicon glyphicon-sort"}), j.defaults({sqlOperators: {equal: {op: "= ?"},not_equal: {op: "!= ?"},"in": {op: "IN(?)",sep: ", "},not_in: {op: "NOT IN(?)",sep: ", "},less: {op: "< ?"},less_or_equal: {op: "<= ?"},greater: {op: "> ?"},greater_or_equal: {op: ">= ?"},between: {op: "BETWEEN ?",sep: " AND "},begins_with: {op: "LIKE(?)",fn: function(a) {
                    return a + "%"
                    ...
                    return "%" + a
                }},is_empty: {op: "= ''"},is_not_empty: {op: "!= ''"},is_null: {op: "IS NULL"},is_not_null: {op: "IS NOT NULL"}},sqlRuleOperator: {"=": function(a) {
                return {val: a,op: "" === a ? "is_empty" : "equal"}
            },"!=": function(a) {
                return {val: a,op: "" === a ? "is_not_empty" : "not_equal"}
            },LIKE: function(a) {
                return "%" == a.slice(0, 1) && "%" == a.slice(-1) ? {val: a.slice(1, -1),op: "contains"} : "%" == a.slice(0, 1) ? {val: a.slice(1),op: "ends_with"} : "%" == a.slice(-1) ? {val: a.slice(0, -1),op: "begins_with"} : void e("Invalid value for LIKE operator")
            },IN: function(a) {
                return {val: a,op: "in"}
            },"NOT IN": function(a) {
                return {val: a,op: "not_in"}
            },"<": function(a) {
                return {val: a,op: "less"}
            },"<=": function(a) {
                return {val: a,op: "less_or_equal"}
            },">": function(a) {
                return {val: a,op: "greater"}
            },">=": function(a) {
                return {val: a,op: "greater_or_equal"}
            },BETWEEN: function(a) {
                return {val: a,op: "between"}
            },IS: function(a) {
                return null !== a && e("Invalid value for IS operator"), {val: null,op: "is_null"}
            },"IS NOT": function(a) {
                return null !== a && e("Invalid value for IS operator"), {val: null,op: "is_not_null"}
            }},sqlStatements: {question_mark: function() {
                var a = [];
            ...
            }},sqlRuleStatement: {question_mark: function(a) {
                var b = 0;
            ...
            }}}), j.extend({getSQL: function(a, b, c) {
            c = void 0 === c ? this.getRules() : c, b = b === !0 ? "\n" : " ", (a === !0 || void 0 === a) && (a = "question_mark"), "string" == typeof a && (a = this.settings.sqlStatements[a]());
            var d = this, h = function i(c) {
                if (c.condition || (c.condition = d.settings.default_condition), -1 === ["AND", "OR"].indexOf(c.condition.toUpperCase()) && e('Unable to build SQL query with condition "{0}"', c.condition), !c.rules)
                    return "";
                var h = [];
                return c.rules.forEach(function(c) {
                    if (c.rules && c.rules.length > 0)
                        ...
                        var j = d.settings.sqlOperators[c.operator], k = d.getOperatorByType(c.operator), l = "";
            ...
            return a ? {sql: h,params: a.run()} : {sql: h}
            ...
            var c = this;
            "string" == typeof a && (a = {sql: a}), "string" == typeof b && (b = this.settings.sqlRuleStatement[b](a.params), a.sql = b.esc(a.sql)), a.sql.toUpperCase().startsWith("SELECT") || (a.sql = "SELECT * FROM table WHERE " + a.sql);
            var d = SQLParser.parse(a.sql);
            d.where || e("No WHERE clause found");
            var f = {condition: this.settings.default_condition,rules: []}, g = f;
            return function h(a, d) {
                if (-1 !== ["AND", "OR"].indexOf(a.operation.toUpperCase())) {
                    d > 0 && g.condition != a.operation.toUpperCase() && (g.rules.push({condition: c.settings.default_condition,rules: []}), g = g.rules[g.rules.length - 1]), g.condition = a.operation.toUpperCase(), d++;
                    var f = g;
                    ...
                    "NOT LIKE" == j && (l.op = "not_" + l.op), g.rules.push({id: c.change("getSQLFieldID", a.left.value, i),field: a.left.value,operator: l.op,value: l.val})
                }
    ...
    }), j.extend({updateDisabledFilters: function(a) {
            var b = a.builder;
